...
@ConditionalOnProperty(
        ...
        havingValue = "true")
@Slf4j(topic = "hoj")
public class AiAssistantSchemaInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        jdbcTemplate.update(
                "INSERT IGNORE INTO ai_assistant_config " +
                        ...
                        "VALUES (1, 0, 'https://api.openai.com/v1', 'gpt-4o-mini', 12, 10)");
        ...
        jdbcTemplate.execute(
                "CREATE TABLE IF NOT EXISTS `ai_assistant_request` (" +
                        ...
                        "CONSTRAINT `fk_ai_request_key` FOREIGN KEY (`api_key_id`) " +
                        "REFERENCES `ai_assistant_api_key` (`id`) ON DELETE SET NULL" +
                        ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");

        log.info("[AI Assistant] Schema is ready.");
    }
}
