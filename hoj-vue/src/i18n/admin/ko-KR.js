export const m = {
  ...
  Admin_Tag: '태그 관리',
  Problem_Difficulty_Admin: '문제 난이도 관리',
  Difficulty_Config_Tip: '난이도를 추가, 삭제, 정렬할 수 있습니다. 문제에서 사용 중인 난이도는 삭제할 수 없습니다.',
  Difficulty_Value: '난이도 ID',
  Difficulty_Display_Text: '표시 문구',
  Difficulty_Border_Color: '테두리 색상',
  Difficulty_Preview: '미리보기',
  Add_Difficulty: '난이도 추가',
  Difficulty_Problem_Count: '사용 문제 수',
  Difficulty_Operation: '작업',
  Difficulty_In_Use: '문제에서 사용 중인 난이도는 삭제할 수 없습니다.',
  Move_Up: '위로',
  Move_Down: '아래로',
  Add_Tag: '태그 추가',
  Update_Tag: '태그 수정',
