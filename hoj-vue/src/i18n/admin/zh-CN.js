export const m = {
  ...
  Admin_Tag: '标签管理',
  Problem_Difficulty_Admin: '题目难度管理',
  Difficulty_Config_Tip: '可新增、删除和排序难度；已被题目使用的难度不能删除。',
  Difficulty_Value: '难度编号',
  Difficulty_Display_Text: '显示文字',
  Difficulty_Border_Color: '外框颜色',
  Difficulty_Preview: '效果预览',
  Add_Difficulty: '新增难度',
  Difficulty_Problem_Count: '使用题目数',
  Difficulty_Operation: '操作',
  Difficulty_In_Use: '该难度已被题目使用，不能删除',
  Move_Up: '上移',
  Move_Down: '下移',
  Add_Tag: '添加标签',
  Update_Tag: '修改标签',
