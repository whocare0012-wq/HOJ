export const m = {
  ...
  Daily_Check_In_Admin: 'Daily Check-In',
  AI_Assistant: 'AI Settings',
  Home_Page: 'Home Page',
  Logout: 'Logout',
  ...
  Admin_Tag: 'Admin Tag',
  Problem_Difficulty_Admin: 'Problem Difficulty',
  Difficulty_Config_Tip: 'Add, delete, and reorder difficulties. A difficulty in use by a problem cannot be deleted.',
  Difficulty_Value: 'Difficulty ID',
  Difficulty_Display_Text: 'Display Text',
  Difficulty_Border_Color: 'Border Color',
  Difficulty_Preview: 'Preview',
  Add_Difficulty: 'Add Difficulty',
  Difficulty_Problem_Count: 'Problems',
  Difficulty_Operation: 'Actions',
  Difficulty_In_Use: 'This difficulty is used by problems and cannot be deleted.',
  Move_Up: 'Move Up',
  Move_Down: 'Move Down',
  Add_Tag: 'Add Tag',
