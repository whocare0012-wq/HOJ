export const m = {
  ...
  Daily_Check_In_Admin: 'デイリーチェックイン管理',
  AI_Assistant: 'AI 設定',
  Home_Page: 'ホーム',
  Logout: 'ログアウト',
  ...
  Admin_Tag: 'タグ管理',
  Problem_Difficulty_Admin: '問題難易度管理',
  Difficulty_Config_Tip: '難易度の追加、削除、並べ替えができます。問題で使用中の難易度は削除できません。',
  Difficulty_Value: '難易度ID',
  Difficulty_Display_Text: '表示テキスト',
  Difficulty_Border_Color: '枠線色',
  Difficulty_Preview: 'プレビュー',
  Add_Difficulty: '難易度を追加',
  Difficulty_Problem_Count: '使用問題数',
  Difficulty_Operation: '操作',
  Difficulty_In_Use: 'この難易度は問題で使用中のため削除できません。',
  Move_Up: '上へ',
  Move_Down: '下へ',
  Add_Tag: 'タグ追加',
  Update_Tag: 'タグ更新',
